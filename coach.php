...
if (isset($_GET['msg_id'])) {
    ...
    $stmt->execute([$msg_id, $coach_username, $coach_username]);
    ...
    <div class="message-box">
        <div class="message-list">
            ...
            <form method="post" action="coach.php">
                <label for="receiver_username">Destinataire (nom d'utilisateur) :</label>
            ...
            <?php else: ?>
                <?php foreach ($messages as $msg): ?>
                    <div class="message-item" onclick="location.href='coach.php?msg_id=<?= $msg['id'] ?>'">
                        <strong>
                            <?= ($msg['sender_username'] === $coach_username) 
        ...
        <div class="message-detail">
            <?php if ($message_detail): ?>
                ...
                <p><strong><?= ($message_detail['sender_username'] === $coach_username) ? "À :" : "De :" ?></strong> 
                   <?= ($message_detail['sender_username'] === $coach_username) 
